...
func (api *DummyObjectLayer) PutObject(ctx context.Context, bucket, object string, data *PutObjReaders, metadata map[string]string, opts ObjectOptions) (objInfo ObjectInfo, err error) {
	return
}
...
func (api *DummyObjectLayer) PutObjectPart(ctx context.Context, bucket, object, uploadID string, partID int, data *PutObjReaders, opts ObjectOptions) (info PartInfo, err error) {
	return
}
