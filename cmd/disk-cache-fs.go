...
func (cfs *cacheFSObjects) Put(ctx context.Context, bucket, object string, data *PutObjReaders, metadata map[string]string, opts ObjectOptions) error {
...
// headers.
func (cfs *cacheFSObjects) PutObject(ctx context.Context, bucket string, object string, r *PutObjReaders, metadata map[string]string, opts ObjectOptions) (objInfo ObjectInfo, retErr error) {
	data := r.Reader
	fs := cfs.FSObjects
	// Lock the object.
