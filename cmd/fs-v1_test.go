...
func TestFSParentDirIsObject(t *testing.T) {
	...
	objInfo, err := obj.PutObject(context.Background(), bucketName, objectName,
		mustGetPutObjReaders(t, bytes.NewReader([]byte(objectContent)), int64(len(objectContent)), "", ""), nil, ObjectOptions{})
	if err != nil {
		t.Fatal(err)
	}
...
func TestFSShutdown(t *testing.T) {
	...
	prepareTest := func() (*FSObjects, string) {
		...
		obj.PutObject(context.Background(), bucketName, objectName, mustGetPutObjReaders(t, bytes.NewReader([]byte(objectContent)), int64(len(objectContent)), "", ""), nil, ObjectOptions{})
		return fs, disk
	}
...
func TestFSPutObject(t *testing.T) {
	...
	_, err := obj.PutObject(context.Background(), bucketName+"non-existent", objectName, mustGetPutObjReaders(t, bytes.NewReader([]byte("abcd")), int64(len("abcd")), "", ""), nil, ObjectOptions{})
	if err == nil {
	...
	_, err = obj.PutObject(context.Background(), bucketName+"non-existent", objectName+"/", mustGetPutObjReaders(t, bytes.NewReader([]byte("abcd")), 0, "", ""), nil, ObjectOptions{})
	if err == nil {
		t.Fatal("Unexpected should fail here, bucket doesn't exist")
	}
	if _, ok := err.(BucketNotFound); !ok {
	...
	_, err = obj.PutObject(context.Background(), bucketName, objectName, mustGetPutObjReaders(t, bytes.NewReader([]byte("abcd")), int64(len("abcd")), "", ""), nil, ObjectOptions{})
	if err != nil {
		t.Fatal(err)
	}
	_, err = obj.PutObject(context.Background(), bucketName, objectName+"/1", mustGetPutObjReaders(t, bytes.NewReader([]byte("abcd")), int64(len("abcd")), "", ""), nil, ObjectOptions{})
	if err == nil {
	...
	_, err = obj.PutObject(context.Background(), bucketName, objectName+"/1/", mustGetPutObjReaders(t, bytes.NewReader([]byte("abcd")), 0, "", ""), nil, ObjectOptions{})
	if err == nil {
...
func TestFSDeleteObject(t *testing.T) {
	...
	obj.MakeBucketWithLocation(context.Background(), bucketName, "")
	obj.PutObject(context.Background(), bucketName, objectName, mustGetPutObjReaders(t, bytes.NewReader([]byte("abcd")), int64(len("abcd")), "", ""), nil, ObjectOptions{})
