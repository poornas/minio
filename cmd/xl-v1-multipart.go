...
func (xl xlObjects) CopyObjectPart(ctx context.Context, srcBucket, srcObject, dstBucket, dstObject, uploadID string, partID int, startOffset int64, length int64, srcInfo ObjectInfo, srcOpts, dstOpts ObjectOptions) (pi PartInfo, e error) {
	...
	partInfo, err := xl.PutObjectPart(ctx, dstBucket, dstObject, uploadID, partID, NewPutObjReaders(srcInfo.Reader, nil, nil), dstOpts)
	if err != nil {
...
func (xl xlObjects) PutObjectPart(ctx context.Context, bucket, object, uploadID string, partID int, r *PutObjReaders, opts ObjectOptions) (pi PartInfo, e error) {
	data := r.Reader
	...
	if md5hex == "" {
		md5hex = hex.EncodeToString(r.MD5Current())
	}
