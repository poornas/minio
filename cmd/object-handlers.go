...
func (api objectAPIHandlers) CopyObjectHandler(w http.ResponseWriter, r *http.Request) {
	...
	if mustReplicateBucket(ctx, r, dstBucket, dstObject, srcInfo.UserDefined, srcInfo.ReplicationStatus.String()) {
	...
	if mustReplicateBucket(ctx, r, dstBucket, dstObject, objInfo.UserDefined, objInfo.ReplicationStatus.String()) {
...
func (api objectAPIHandlers) PutObjectHandler(w http.ResponseWriter, r *http.Request) {
	...
	if mustReplicateBucket(ctx, r, bucket, object, metadata, "") {
...
func (api objectAPIHandlers) CompleteMultipartUploadHandler(w http.ResponseWriter, r *http.Request) {
	...
	setPutObjHeaders(w, objInfo, false)
	if mustReplicateBucket(ctx, r, bucket, object, objInfo.UserDefined, objInfo.ReplicationStatus.String()) {
		defer replicateObject(ctx, bucket, object, objInfo.VersionID, objectAPI, &eventArgs{
