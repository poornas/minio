...
func TestRepeatPutObjectPart(t *testing.T) {
	...
	_, err = objLayer.PutObjectPart(context.Background(), "bucket1", "mpartObj1", uploadID, 1, mustGetPutObjReaders(t, bytes.NewReader(fiveMBBytes), 5*humanize.MiByte, md5Hex, ""), opts)
	if err != nil {
		t.Fatal(err)
	}
...
func TestXLDeleteObjectBasic(t *testing.T) {
	...
	_, err = xl.PutObject(context.Background(), "bucket", "dir/obj", mustGetPutObjReaders(t, bytes.NewReader([]byte("abcd")), int64(len("abcd")), "", ""), nil, ObjectOptions{})
	if err != nil {
...
func TestXLDeleteObjectDiskNotFound(t *testing.T) {
	...
	_, err = obj.PutObject(context.Background(), bucket, object, mustGetPutObjReaders(t, bytes.NewReader([]byte("abcd")), int64(len("abcd")), "", ""), nil, opts)
	if err != nil {
		t.Fatal(err)
	}
...
func TestHealing(t *testing.T) {
	...
	_, err = obj.PutObject(context.Background(), bucket, object, mustGetPutObjReaders(t, bytes.NewReader(data), length, "", ""), nil, ObjectOptions{})
	if err != nil {
		t.Fatal(err)
	}
