...
func (fs *FSObjects) CopyObject(ctx context.Context, srcBucket, srcObject, dstBucket, dstObject string, srcInfo ObjectInfo, srcOpts, dstOpts ObjectOptions) (oi ObjectInfo, e error) {
	...
	objInfo, err := fs.putObject(ctx, dstBucket, dstObject, srcInfo.PutObjReaders, srcInfo.UserDefined, dstOpts)
	if err != nil {
...
func (fs *FSObjects) PutObject(ctx context.Context, bucket string, object string, r *PutObjReaders, metadata map[string]string, opts ObjectOptions) (objInfo ObjectInfo, retErr error) {
...
func (fs *FSObjects) putObject(ctx context.Context, bucket string, object string, r *PutObjReaders, metadata map[string]string, opts ObjectOptions) (objInfo ObjectInfo, retErr error) {
	...
	if fsMeta.Meta["etag"] == "" {
		fsMeta.Meta["etag"] = hex.EncodeToString(r.MD5Current())
	}
