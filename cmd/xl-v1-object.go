...
func (xl xlObjects) CopyObject(ctx context.Context, srcBucket, srcObject, dstBucket, dstObject string, srcInfo ObjectInfo, srcOpts, dstOpts ObjectOptions) (oi ObjectInfo, e error) {
	...
	objInfo, err := xl.putObject(ctx, dstBucket, dstObject, NewPutObjReaders(hashReader, nil, nil), srcInfo.UserDefined, dstOpts)
	if err != nil {
		return oi, toObjectErr(err, dstBucket, dstObject)
	}
...
// object operations.
func (xl xlObjects) PutObject(ctx context.Context, bucket string, object string, data *PutObjReaders, metadata map[string]string, opts ObjectOptions) (objInfo ObjectInfo, err error) {
...
func (xl xlObjects) putObject(ctx context.Context, bucket string, object string, r *PutObjReaders, metadata map[string]string, opts ObjectOptions) (objInfo ObjectInfo, err error) {
	data := r.Reader
	...
	if opts.ServerSideEncryption != nil {
		if encMD5Sum, _, err := r.EncryptedMD5Sum(); err == nil {
