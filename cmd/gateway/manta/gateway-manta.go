...
func (t *tritonObjects) PutObject(ctx context.Context, bucket, object string, r *minio.PutObjReaders, metadata map[string]string, opts minio.ObjectOptions) (objInfo minio.ObjectInfo, err error) {
	data := r.Reader
