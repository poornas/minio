...
func (l *gcsGateway) PutObject(ctx context.Context, bucket string, key string, r *minio.PutObjReaders, metadata map[string]string, opts minio.ObjectOptions) (minio.ObjectInfo, error) {
	data := r.Reader
...
func (l *gcsGateway) PutObjectPart(ctx context.Context, bucket string, key string, uploadID string, partNumber int, r *minio.PutObjReaders, opts minio.ObjectOptions) (minio.PartInfo, error) {
	data := r.Reader
