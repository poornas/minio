...
func (l *gcsGateway) NewMultipartUpload(ctx context.Context, bucket string, key string, metadata map[string]string, opts minio.ObjectOptions) (uploadID string, err error) {
