...
func (a *azureObjects) PutObject(ctx context.Context, bucket, object string, r *minio.PutObjReaders, metadata map[string]string, opts minio.ObjectOptions) (objInfo minio.ObjectInfo, err error) {
	data := r.Reader
...
func (a *azureObjects) PutObjectPart(ctx context.Context, bucket, object, uploadID string, partID int, r *minio.PutObjReaders, opts minio.ObjectOptions) (info minio.PartInfo, err error) {
	data := r.Reader
