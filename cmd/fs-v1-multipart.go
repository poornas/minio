...
func (fs *FSObjects) CopyObjectPart(ctx context.Context, srcBucket, srcObject, dstBucket, dstObject, uploadID string, partID int,
	...
	partInfo, err := fs.PutObjectPart(ctx, dstBucket, dstObject, uploadID, partID, NewPutObjReaders(srcInfo.Reader, nil, nil), dstOpts)
	if err != nil {
...
func (fs *FSObjects) PutObjectPart(ctx context.Context, bucket, object, uploadID string, partID int, r *PutObjReaders, opts ObjectOptions) (pi PartInfo, e error) {
	data := r.Reader
	...
	if opts.ServerSideEncryption != nil {
		if encMD5Sum, actualMD5Sum, err := r.EncryptedMD5Sum(); err == nil {
			etag = encMD5Sum
		...
		etag = hex.EncodeToString(r.MD5Current())
	}
