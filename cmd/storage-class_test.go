...
func testObjectQuorumFromMeta(obj ObjectLayer, instanceType string, dirs []string, t TestErrHandler) {
	...
	object1 := "object1"
	_, err = obj.PutObject(context.Background(), bucket, object1, mustGetPutObjReaders(t, bytes.NewReader(data), int64(len(data)), "", ""), nil, opts)
	if err != nil {
	...
	_, err = obj.PutObject(context.Background(), bucket, object2, mustGetPutObjReaders(t, bytes.NewReader(data), int64(len(data)), "", ""), metadata2, opts)
	if err != nil {
		t.Fatalf("Failed to putObject %v", err)
	}
	...
	_, err = obj.PutObject(context.Background(), bucket, object3, mustGetPutObjReaders(t, bytes.NewReader(data), int64(len(data)), "", ""), metadata3, opts)
	if err != nil {
		t.Fatalf("Failed to putObject %v", err)
	}
	...
	_, err = obj.PutObject(context.Background(), bucket, object4, mustGetPutObjReaders(t, bytes.NewReader(data), int64(len(data)), "", ""), metadata4, opts)
	if err != nil {
		t.Fatalf("Failed to putObject %v", err)
	}
	...
	_, err = obj.PutObject(context.Background(), bucket, object5, mustGetPutObjReaders(t, bytes.NewReader(data), int64(len(data)), "", ""), metadata5, opts)
	if err != nil {
		t.Fatalf("Failed to putObject %v", err)
	}
	...
	_, err = obj.PutObject(context.Background(), bucket, object6, mustGetPutObjReaders(t, bytes.NewReader(data), int64(len(data)), "", ""), metadata6, opts)
	if err != nil {
		t.Fatalf("Failed to putObject %v", err)
	}
	...
	_, err = obj.PutObject(context.Background(), bucket, object7, mustGetPutObjReaders(t, bytes.NewReader(data), int64(len(data)), "", ""), metadata7, opts)
	if err != nil {
		t.Fatalf("Failed to putObject %v", err)
	}
