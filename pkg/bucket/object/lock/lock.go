...
func ParseObjectLockConfig(reader io.Reader) (*Config, error) {
	...
	// If namespace is empty, set a default value before returning.
	// This is required to treat namespace as optional for buckets
	// created without namespacing in the ObjectLockConfiguration.
	if config.XMLNS == "" {
